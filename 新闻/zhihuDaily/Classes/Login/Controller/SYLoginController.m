...
- (IBAction)login:(id)sender {
    ...
    //self.nameLabel.text=@"15251329382";
    //self.password.text=@"ad1111";
    if (result && [self.nameLabel.text isEqualToString:@"15251329382"] && [self.password.text isEqualToString:@"ad1111"]) {
